function addRecipes(numRecipes){
                ...
                `<div class="d-flex">` +
                    ...
                    `<div class = "dflex flex-column w-50 p-4">` + 
                        ...
                        `<div class="d-flex">` +
                            ...
                            `<button onclick='addFavorite("${recipeData["title"]}", "${recipeData["recipeID"]}")' class="btn btn-success" id="${recipeData["recipeID"]}">Favorite</button>` +    
                       `</div>` +
                    `<div>` +
                `</div>` +
            `</div>` +
...
function showRecipe(identifier){
    ...
    console.log($(`#${identifier}-card`).offset().top + $("#browser-recipes").scrollTop());
    $("#browser-recipes").animate(
        {
          scrollTop: $(`#${identifier}-card`).offset().top + $("#browser-recipes").scrollTop()
        },
        800 
    )
}
